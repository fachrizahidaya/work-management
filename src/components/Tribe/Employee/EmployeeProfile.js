        ...
        <View style={styles.content}>
          <View>
            <View style={styles.information}>
              <Text
                style={{ fontSize: 20, fontWeight: "400", color: "#3F434A" }}
              >
              ...
              <Text
                style={{ fontSize: 14, fontWeight: "400", color: "#8A9099" }}
              >
                {`(${
                  employee?.data?.gender.charAt(0).toUpperCase() +
                  employee?.data?.gender.slice(1)
                })`}
              </Text>
            </View>
