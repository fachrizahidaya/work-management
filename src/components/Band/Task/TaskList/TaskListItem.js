...
import { Avatar, Box, Button, Flex, HStack, Icon, Pressable, Text, useSafeArea } from "native-base";
          ...
          <Flex flexDir="row" justifyContent="space-between" alignItems="center">
            ...
            <Flex flexDir="row" alignItems="center" gap={2}>
              {responsible ? (
                <Avatar
                  source={{
                    uri: image ? `https://dev.kolabora-app.com/api-dev/image/${image}/thumb` : null,
                  }}
                  size="sm"
                  bgColor="primary.600"
                >
